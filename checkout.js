document.addEventListener('DOMContentLoaded', function() {
        ...
        checkoutItems.innerHTML = `
            <div class="empty-cart-message">
                <div style="text-align:center; padding:40px 20px; color:#888;">
                    ...
                    <button class="main-btn" onclick="location.href='product.html'" style="margin-top:20px;">
                        Continue Shopping
                    </button>
                </div>
            </div>
            ...
            itemElement.innerHTML = `
                ...
                <div class="checkout-item-details">
                    ...
                    <div class="checkout-item-meta">
                        ...
                        ${item.finish} • ${item.sheen}
                    </div>
                </div>
                <div class="checkout-item-price">$${item.total}</div>
            `;
    ...
    function renderInvoiceDetails() {
        ...
        orderData.items.forEach(item => {
            ...
            itemElement.innerHTML = `
                <span>${item.name} (${item.yards}yd)</span>
